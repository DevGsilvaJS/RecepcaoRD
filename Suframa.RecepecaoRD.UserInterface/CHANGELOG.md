...
- Crie um projeto angular com ng: `ng new Suframa.RecepecaoRD.UserInterface --defaults --skip-install --skip-git --no-standalone `.
- Atualize angular.json com a porta.
- Criar o arquivo de projeto (`Suframa.RecepecaoRD.UserInterface.esproj`).
